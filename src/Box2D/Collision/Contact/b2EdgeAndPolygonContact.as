...
package Box2D.Collision.Contact
{
	...
	public class b2EdgeAndPolygonContact extends b2Contact
	{
		...
		{
			return new b2EdgeAndPolygonContact(p_fixtureA, p_fixtureB);  // TODO: Think about pool
		}
		 ...
		 * @param p_fixtureB
		 */
		public function b2EdgeAndPolygonContact(p_fixtureA:b2Fixture, p_fixtureB:b2Fixture)
		{
